...
export interface ApiAudioplexAudioplex extends Schema.CollectionType {
  collectionName: 'audioplexes';
  info: {
    singularName: 'audioplex';
    pluralName: 'audioplexes';
    displayName: 'audioplex';
  };
  options: {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::audioplex.audioplex': ApiAudioplexAudioplex;
